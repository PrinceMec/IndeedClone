...
<html>
	<head>
		...
		<script src="resources/js/jobseeker-registration-page2.js"></script>
		<link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/jobseeker-registration-page2.css' />" />
	</head>
	...
	<div class="container mt-5">
        <div class="row">
            <div class="col-lg-5 offset-lg-3">
                <form action="jobseeker-registration-page3" method="post" onsubmit="return validateForm()">
