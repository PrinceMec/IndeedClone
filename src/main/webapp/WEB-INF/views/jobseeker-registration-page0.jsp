...
<head>
  ...
  <script src="resources/js/jobseeker-registration-page0.js"></script>
  <link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/jobseeker-registration-page0.css' />" />
</head>
<body>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-lg-5 offset-lg-3">
          <form action="jobseeker-registration-page1" method="post" onsubmit="return validateForm()" id="registrationForm">
