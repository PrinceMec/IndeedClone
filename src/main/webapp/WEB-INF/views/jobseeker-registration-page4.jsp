...
<script src="resources/js/jobseeker-registration-page4.js"></script>
<link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/jobseeker-registration-page4.css' />" />
	...
	<div class="container mt-5">
        <div class="row">
            <div class="col-lg-5 offset-lg-3">
                <form action="jobseeker-registration-page5" method="post" onsubmit="return validateForm()">
                <h2>Add education</h2>
                
                <br>
                    <div id="education-error" class="error-message" style="color:red;"></div>
                    
                    <div class="form-group">
                        <label for="levelOfEducation">Level of education*</label>
                        <input type="text" class="form-control" id="levelOfEducation" name="levelOfEducation">
                    </div>
