...
<html>
	<head>
		...
		<script src="resources/js/jobseeker-registration-page1.js"></script>
		<link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/jobseeker-registration-page1.css' />" />
	</head>
	...
	<div class="container mt-5">
        <div class="row">
            <div class="col-lg-5 offset-lg-3">
                <form action="jobseeker-registration-page2" method="post" onsubmit="return validateForm()">
                ...
                <br>
                    ...
                    <div class="form-group">
                        ...
                        <span id="first-name-error" class="error-message" style="color:red;"></span>
                    </div>
                    <div class="form-group">
                        <label for="lastName">Last name*</label>
                        <input type="text" class="form-control" id="lastName" name="lastName">
                        <span id="last-name-error" class="error-message" style="color:red;"></span>
                    </div>
                    <div class="">
