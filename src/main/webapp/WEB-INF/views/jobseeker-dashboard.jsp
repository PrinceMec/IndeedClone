...
<html>
	<head>
		...
		<title>Job Search Canada | Indeed</title>
		<link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/jobseeker-dashboard.css' />" />
		<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
		<!-- <script src="resources/js/jobseeker-dashboard.js"></script> -->
	  ...
	  <form class="text-center" action="job-searched-results-page">
	    <div class="row justify-content-center">
	      ...
	      <div class="">
	        ...
	        <input type="text" class="form-control" style="width: 360px;" placeholder="job title or keywords" name="jobTitle">
	      </div>
	      <div class="ml-2">
	        <input type="text" class="form-control" style="width: 360px;" placeholder="city" name="city">
	      </div>
	      <div class="ml-2">
	        <button type="submit" class="btn btn-primary" style="width: 100px; background-color:rgb(37, 87, 167); border-radius:7px;">Find jobs</button>
	      </div>
	    </div>
	  </form>
	</div>
	...
	<br>
	  ...
	  <div class="row">
	    <div class="col-md-4" style="margin-right: 0px; overflow-y: scroll;">
	      ...
	      <div class="list-group" style="max-height: 700px;">
