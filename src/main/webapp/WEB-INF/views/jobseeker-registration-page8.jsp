...
<script src="resources/js/jobseeker-registration-page8.js"></script>
<link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/jobseeker-registration-page8.css' />" />
	...
	<div class="container mt-5">
        <div class="row">
            <div class="col-lg-5 offset-lg-3">
                <form action="jobseeker-registration-page9" method="post" onsubmit="return validateForm()">
                <h2>What certifications or licences do you have?</h2>
                
                <div id="certifications-error" class="error-message" style="color:red;"></div>
                <br>
                    <!-- Form content goes here -->
                    <div class="form-group">
                        <label for="certifications">Enter Certifications or licences separated by commas</label>
                        <input type="text" class="form-control" id="certifications" name="certifications" placeholder="Add a certification or license">
                    </div>
