function loadJobDetails(jobId) {
	...
	$.ajax({
		url: "jobs/" + jobId, // Replace with your controller mapping
		type: "GET",
		...
		var jobTypes = data.jobType; // Assuming data.jobType is an array
		...
		var schedule = data.jobSchedule; // Assuming data.jobType is an array
